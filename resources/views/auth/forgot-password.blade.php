    ...
    <div style="width: 100%; max-width: 480px; padding: 24px;">
        <div class="login-card">
            ...
            <div style="text-align: center; margin-bottom: 32px;">
                ...
                <p style="color: #8FA8BF; font-size: 11px; text-transform: uppercase; letter-spacing: 0.2em; font-weight: 600;">Reset Password</p>
            </div>

            <div style="color: #8FA8BF; font-size: 14px; margin-bottom: 24px; line-height: 1.6; font-weight: 400;">
            ...
            <div style="text-align: center; margin-top: 24px;">
                <a href="{{ route('login') }}" style="font-size: 12px; color: #64748b; text-decoration: none; font-weight: 500; transition: color 0.3s;" onmouseover="this.style.color='#FBC246'" onmouseout="this.style.color='#64748b'">
                    ← Back to Login
                </a>
            </div>
        </div>
